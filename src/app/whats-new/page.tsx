...
export default function WhatsNew() {
  return (
    <main className="mx-14 md:mx-20 lg:mx-36 mt-28 mb-16 min-h-lvh">
      ...
      <iframe className="mt-6 aspect-video w-full" src="https://www.youtube.com/embed/0eA0s3H4aYE?si=fKgjVJpLaktIScoQ&amp;start=1" title="YouTube video player" allowFullScreen></iframe>
