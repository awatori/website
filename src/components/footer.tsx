    ...
    <footer className="flex flex-col px-8 py-5 text-white w-full bg-black px-14">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <nav className="flex flex-col text-center md:flex-row md:text-left justify-between gap-x-6 text-sm">
          ...
          <Link href="/projects" className="hover:underline mt-2 md:mt-0">{t("projects")}</Link>
          <Link href="/our-creatives" className="hover:underline mt-2 md:mt-0">{t("creatives")}</Link>
          <Link href="/contact-us" className="hover:underline mt-2 md:mt-0">{t("contact")}</Link>
        </nav>
